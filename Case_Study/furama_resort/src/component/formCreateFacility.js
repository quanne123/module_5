                        ...
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">
                                    Thêm mới dịch vụ <i className="fa-sharp fa-solid fa-user"></i>
                                </h5>
                                <button
                                    type="button"
                                ...
                                <form method="post">
                                    ...
                                    <div className="mb-3 row">
                                        ...
                                        <div className="col-sm-10">
                                            <select className="form-control" onChange={() => facility()} id="selectValue">
                                    ...
                                    </div> <div className="mb-3 row" id="standardAdd">
